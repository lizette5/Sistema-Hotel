...
public:
    ...
    void setupUi(QDialog *Gui_Index_Registro)
    {
        ...
        Gui_Index_Registro->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 127);"));
        ...
        New_Registro_Button->setGeometry(QRect(540, 110, 51, 51));
        New_Registro_Button->setStyleSheet(QString::fromUtf8("#New_Registro_Button{\n"
"	background-color: transparent;\n"
"	border-image: url(:/imagenes/imagenes/agregar_unpressed.png);\n"
"}\n"
"\n"
"#New_Registro_Button:pressed{\n"
"	background-color: transparent;\n"
...
"}"));
        ...
        Regresar_->setGeometry(QRect(520, 340, 81, 31));
        Regresar_->setStyleSheet(QString::fromUtf8("font: 75 10pt \"Times New Roman\";\n"
"background-color: rgb(255, 184, 62);"));
        ...
        edit_registros_button->setGeometry(QRect(540, 180, 51, 51));
...
"}"));
        ...
        delete_registros_button->setGeometry(QRect(540, 250, 51, 51));
...
"}"));
    ...
    void retranslateUi(QDialog *Gui_Index_Registro)
    {
        ...
        New_Registro_Button->setText(QString());

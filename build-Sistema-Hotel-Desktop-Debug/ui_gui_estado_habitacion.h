...
public:
    ...
    void setupUi(QDialog *gui_estado_habitacion)
    {
        ...
        gui_estado_habitacion->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 127);"));
        ...
        label_3->setGeometry(QRect(70, 10, 211, 20));
        QFont font;
    ...
    void retranslateUi(QDialog *gui_estado_habitacion)
    {
        ...
        label_3->setText(QCoreApplication::translate("gui_estado_habitacion", "Estado de habitaci\303\263n", nullptr));
    } // retranslateUi

...
public:
    ...
    void setupUi(QDialog *Gui_Empleado)
    {
        ...
        Gui_Empleado->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 127);"));
        ...
        Aceptar_button->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 184, 62);"));
        ...
        Cancel_button->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 184, 62);"));
    ...
    void retranslateUi(QDialog *Gui_Empleado)
    {
        ...
        lineEdit_nombreE->setPlaceholderText(QCoreApplication::translate("Gui_Empleado", "Ingrese dato con mayuscula", nullptr));
        lineEdit_apellidoE->setPlaceholderText(QCoreApplication::translate("Gui_Empleado", "Ingrese dato con mayuscula", nullptr));
        lineEdit_sueldoE->setText(QString());
        lineEdit_sueldoE->setPlaceholderText(QCoreApplication::translate("Gui_Empleado", "00.00", nullptr));
        lineEdit_ocupacionE->setPlaceholderText(QCoreApplication::translate("Gui_Empleado", "Ingrese dato con mayuscula", nullptr));

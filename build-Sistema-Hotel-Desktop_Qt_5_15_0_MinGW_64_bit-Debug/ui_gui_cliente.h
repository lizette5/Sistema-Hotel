...
public:
    ...
    void setupUi(QDialog *Gui_Cliente)
    {
        ...
        Gui_Cliente->resize(372, 352);
        Gui_Cliente->setAutoFillBackground(false);
        Gui_Cliente->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 127);"));
        groupBox = new QGroupBox(Gui_Cliente);
        groupBox->setObjectName(QString::fromUtf8("groupBox"));
        groupBox->setGeometry(QRect(10, 10, 351, 331));
        QFont font;

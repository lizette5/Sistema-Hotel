...
public:
    ...
    void setupUi(QDialog *gui_factura)
    {
        ...
        gui_factura->resize(521, 523);
        gui_factura->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 127);"));
        ...
        groupBox_2->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 127);"));
        ...
        groupBox_3->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 127);"));
        ...
        pushButton->setGeometry(QRect(430, 490, 75, 23));
    ...
    void retranslateUi(QDialog *gui_factura)
    {
        ...
        pushButton->setText(QCoreApplication::translate("gui_factura", "ACEPTAR", nullptr));
    } // retranslateUi

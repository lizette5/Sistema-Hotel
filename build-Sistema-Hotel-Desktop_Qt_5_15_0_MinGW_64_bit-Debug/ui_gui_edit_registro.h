...
public:
    ...
    void setupUi(QDialog *GUI_Edit_Registro)
    {
        ...
        GUI_Edit_Registro->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 127);"));
...
"background-color: rgb(255, 255, 127);"));
        ...
        Editar_Button->setGeometry(QRect(20, 310, 101, 41));
        QFont font1;
...
"background-color: rgb(255, 184, 62);"));
        ...
        Cancelar_button->setGeometry(QRect(150, 310, 101, 41));
        QFont font2;
        ...
        font2.setWeight(9);
        Cancelar_button->setFont(font2);
        Cancelar_button->setStyleSheet(QString::fromUtf8("font: 75 12pt \"Times New Roman\";\n"
"background-color: rgb(255, 184, 62);"));
        ...
        habit_Edit_Button->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 184, 62);"));
        ...
        Registrar_button_2->setGeometry(QRect(270, 310, 101, 41));
...
"background-color: rgb(255, 184, 62);"));
    ...
    void retranslateUi(QDialog *GUI_Edit_Registro)
    {
        ...
        groupBox->setTitle(QCoreApplication::translate("GUI_Edit_Registro", "Editar Registro", nullptr));
